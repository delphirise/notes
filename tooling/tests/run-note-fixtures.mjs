...
try {
  ...
  console.error('Playwright is not installed. Install with: npm --prefix tooling i -D playwright');
  process.exit(2);
}
...
const templatesPath = path.join(repoRoot, 'app', 'pages', 'Templates.html');
